...
interest_level: high
summary: Learn the mean-field description of weak-coupling pairing, including the
  energy gap, self-consistency conditions, and theoretical assumptions.
scope_note: Change this level in the Demo to explore how it affects the starting point
  of a note.
tags:
- tag_physics
evidence_refs: []
semantic_role: theory
---
